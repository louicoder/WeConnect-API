import unittest
from flask import Blueprint, Flask, request, json, jsonify, make_responsefrom views import reviews
...
class Test_User_Routes(unittest.TestCase):
    ...
    def test_user_registration(self):
        reg = self.app_client.post('/api/v1/auth/register', content_type='application/json',
